    ...
    <section id="faq" className="py-20 px-4 sm:px-6 lg:px-8 scroll-mt-16">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4 inline-block px-6 py-3 rounded-2xl section-title">
            {t.faq.title}
          </h2>
          <br />
          <p className="text-gray-500 text-lg mt-6 font-semibold inline-block px-6 py-3 rounded-xl section-subtitle">
            {t.faq.subtitle}
          </p>
        </div>
